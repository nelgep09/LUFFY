...
- [ ] **luffy/test.py:1590** - //github.com/Dao-AILab/flash-attention/pull/824 is merged
...
- [ ] **luffy/verl/verl/mix_src/mix_vllm_rollout.py:43** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/models/llama/megatron/modeling_llama_megatron.py:37** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_3_1/model_loader.py:96** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_4_2/arg_utils.py:44** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_4_2/hf_weight_loader.py:81** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_4_2/megatron_weight_loaders.py:325** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/hf_weight_loader.py:32** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/parallel_state.py:177** - (see surrounding TODO comments)
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/parallel_state.py:249** - check why True is not work in Ray trainer
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/parallel_state.py:253** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/hf_weight_loader.py:29** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/parallel_state.py:185** - (see surrounding TODO comments)
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/parallel_state.py:257** - check why True is not work in Ray trainer
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/parallel_state.py:262** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/trainer/fsdp_sft_trainer.py:16** - (see surrounding TODO comments)
- [ ] **luffy/verl/verl/trainer/fsdp_sft_trainer.py:77** - add checkpoint manager
- [ ] **luffy/verl/verl/trainer/fsdp_sft_trainer.py:140** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/utils/hdfs_io.py:67** - (see surrounding TODO comments)
- [ ] **luffy/verl/verl/utils/hdfs_io.py:102** - (see surrounding TODO comments)
...
- [ ] **luffy/verl/verl/workers/rollout/vllm_rollout/vllm_rollout.py:43** - (see surrounding TODO comments)
